...
function Resume() {
  ...
  const roles = [
    {
      ...
      // Timeline range as % of total tenure (May 2022 → today, ~48 mos)
      range: { from: 0.66, to: 1.00 },
      summary:
        "Operational leadership of DSV's regional freight business. Carrying forward the modular product portfolio defined in the Contract Manager role into day-to-day execution.",
      bullets: [
        "Operational accountability for regional freight flows; carrier mix, service KPIs, escalations.",
        "Continuing to embed the modular pricing catalogue across new customer wins.",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Led innovation as a commercial lever, not a cost. Made the call to bring sustainability and technology investments to the commercial table as differentiators.",
        ...
        "Executive customer relationships. Trusted counterpart at customer C-suite and procurement leadership level.",
      ],
    },
    {
      id: "cm",
      ...
      summary:
        "Commercial and product accountability for DSV Contract Logistics' distribution proposition. Multi-site portfolio — 60,000 m², 150 FTE, SQAS- and PharmaQMS-certified.",
      bullets: [
        "Took the decision to move freight from bespoke per-customer setups and cost-plus pricing toward a modular product catalogue priced on delivered value — a structural change in how the business goes to market.",
        "Established the governance framework, catalogue definition, change control, pricing discipline, and service KPIs that allow freight propositions to scale across the customer base without eroding margin.",
        ...
        "Deployed cleaning robotics and drone-based inventory systems in a regulated environment, delivering a 30% reduction in labour-intensive processes without compromising SQAS or PharmaQMS standing.",
        "Built the leadership layer. Led through site and operational managers across multiple locations.",
      ],
    },
  ];
  ...
  return (
    <section className="lp-resume" id="resume" ref={sectionRef}>
      ...
      <div className="lp-resume__cta">
        <a href="../../uploads/Alexander van der Plas _ LinkedIn.pdf" className="btn btn--ghost" target="_blank" rel="noopener noreferrer">
          Download PDF ↓
        </a>
        <a href="https://www.linkedin.com" className="lp-resume__linkedin" target="_blank" rel="noopener noreferrer">
          ↗ View on LinkedIn
        </a>
      </div>
    </section>
