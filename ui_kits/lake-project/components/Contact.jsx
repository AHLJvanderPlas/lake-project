          ...
          {!sent ? (
            <form className="lp-contact__form" onSubmit={onSubmit}>
              ...
              <div className="lp-contact__submit">
                ...
                <span className="lp-contact__legal">
                  Reads only by Alexander · never listed
                </span>
              </div>
            </form>
          ) : (
            <div className="lp-contact__sent">
              ...
              <p className="lp-contact__sent-text">
                I'll reply within two working days, usually from a Dutch evening. If it's urgent — most things aren't — say so in the subject line of any follow-up.
              </p>
